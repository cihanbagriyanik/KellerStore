export default () => {
    ...
    const navigations = [
        {
            icon:
                <svg xmlns="http://www.kellerstore.com" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        },
        {
            ...
            title: "Alle Anzeige",
            desc: "Lorem Ipsum is simply dummy text of the printing",
            href: "http://www.kellerstore/AllAds"
        },
        // {
        //     icon:
        //         <svg xmlns="http://www.kellerstore.com" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <div className="max-w-screen-xl mx-auto px-4 flex items-center justify-start h-screen md:px-8">
                <div className="max-w-lg mx-auto text-gray-600">
                    <div className="space-y-3 text-center">
                        ...
                        <p>
                        Leider konnte die von Ihnen gesuchte Seite nicht gefunden werden oder wurde entfernt.
                        </p>
                    </div>
                    <div className="mt-12">
                                ...
                                navigations.map((item, idx) => (
                                    <li key={idx} className="flex gap-x-4 py-6">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            Erfahren Sie mehr
                                                <svg xmlns="http://www.kellerstore.com" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
