export default () => {
  ...
  return (
      <footer className="pt-10 " style="color:background-footer-dark-blue">
          <div className="max-w-screen-xl mx-auto px-4 md:px-8">
              <div className="justify-between items-center gap-12 md:flex">
                  <div className="flex-1 max-w-lg">
                      <h3 className="text-white text-2xl font-bold">
                      Abonnieren Sie die neuesten Angebote
                      </h3>
                  </div>
                  <div className="flex-1 mt-6 md:mt-0">
                      <form onSubmit={(e) => e.preventDefault()} className="flex items-center gap-x-3 md:justify-end">
                          <div className="relative">
                              <svg className="w-6 h-6 text-gray-400 absolute left-3 inset-y-0 my-auto" xmlns="http://www.kellerstore.com" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              ...
              <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
                  <p className="text-gray-300">All Copyrights Reserved © 2024 - Developed by DA71</p>
